...
app.AppView = Backbone.View.extend({
  ...
  render: function() {
    ...
    // console.log("Test 1 : "+ completed+"-->"+remaining);
	...
	// If hit enter in the main input field, create new todo model,
	// persisting it to localstorage
	createOnEnter: function(event){
		// this refers to View and not the DOM element
	...
	toggleAllComplete: function(){
		...
		console.log('yep'+ this.allcheckbox.length)
